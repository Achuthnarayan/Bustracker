...
const ROUTES = [
  {
    ...
    startTime: '07:22', eveningStartTime: '16:00', duration: '30 mins', totalDuration: 30, price: 25, active: true,
    stops: [
      { name: 'Koratty',                                   order: 1, expectedTime: 0,  latitude: 10.268317, longitude: 76.350256 },
      { name: 'Konoor',                                    order: 2, expectedTime: 6,  latitude: 10.271612, longitude: 76.366130 },
      { name: 'Valungamury',                               order: 3, expectedTime: 12, latitude: 10.276877, longitude: 76.380570 },
      { name: 'Carborundum',                               order: 4, expectedTime: 18, latitude: 10.276876, longitude: 76.387366 },
      { name: 'Nalukettu',                                 order: 5, expectedTime: 24, latitude: 10.274628, longitude: 76.392654 },
