...
const ROUTES = [
  {
    ...
    stops: [
      ...
      { name: 'Manjaly',                                   order: 2, expectedTime: 10, latitude: 10.1520, longitude: 76.2720 },
      { name: 'Kunnukara',                                 order: 3, expectedTime: 22, latitude: 10.1680, longitude: 76.3180 },
      { name: 'Chengamanad',                               order: 4, expectedTime: 32, latitude: 10.1810, longitude: 76.3650 },
      { name: 'Angamaly',                                  order: 5, expectedTime: 42, latitude: 10.1960, longitude: 76.3800 },
      { name: 'Athani',                                    order: 6, expectedTime: 52, latitude: 10.2050, longitude: 76.4350 },
      { name: 'Karukutty',                                 order: 7, expectedTime: 63, latitude: 10.2133, longitude: 76.5047 },
