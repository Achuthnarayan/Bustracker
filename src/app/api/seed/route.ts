...
const ROUTES = [
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Pudukkad',                                  order: 2, expectedTime: 18, latitude: 10.4167, longitude: 76.2833 },
      { name: 'Kodakara',                                  order: 3, expectedTime: 35, latitude: 10.3667, longitude: 76.3167 },
      { name: 'Perambra',                                  order: 4, expectedTime: 50, latitude: 10.3333, longitude: 76.3333 },
      { name: 'Chalakudy',                                 order: 5, expectedTime: 63, latitude: 10.3000, longitude: 76.3333 },
      { name: 'Koratty',                                   order: 6, expectedTime: 78, latitude: 10.2667, longitude: 76.3833 },
