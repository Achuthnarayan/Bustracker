...
const ROUTES = [
  {
    ...
    description: 'North Paravur · Cherai · Moothakunnam · Varapuzha · Angamaly · Kalady · Karukutty · SCMS',
    startTime: '07:30', eveningStartTime: '16:00', duration: '65 mins', totalDuration: 65, price: 25, active: true,
    stops: [
      { name: 'North Paravur',                             order: 1,  expectedTime: 0,  latitude: 10.1500, longitude: 76.2167 },
      { name: 'Cherai Junction',                           order: 2,  expectedTime: 8,  latitude: 10.1620, longitude: 76.2450 },
      { name: 'Moothakunnam',                              order: 3,  expectedTime: 16, latitude: 10.1750, longitude: 76.2900 },
      { name: 'Varapuzha',                                 order: 4,  expectedTime: 24, latitude: 10.1850, longitude: 76.3200 },
      { name: 'Angamaly',                                  order: 5,  expectedTime: 35, latitude: 10.1960, longitude: 76.3800 },
      { name: 'Kalady',                                    order: 6,  expectedTime: 48, latitude: 10.2050, longitude: 76.4500 },
      { name: 'Karukutty',                                 order: 7,  expectedTime: 58, latitude: 10.2150, longitude: 76.5000 },
      { name: 'SCMS School of Engineering and Technology', order: 8,  expectedTime: 65, latitude: 10.2268, longitude: 76.5419 },
    ],
  },
  {
    routeId: 'ROUTE_2',
