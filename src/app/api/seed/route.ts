...
const ROUTES = [
  {
    ...
    stops: [
      ...
      { name: 'Angamaly Junction',      order: 3, expectedTime: 12, latitude: 10.2000, longitude: 76.5700 },
      { name: 'Karukutty Junction',     order: 4, expectedTime: 22, latitude: 10.2100, longitude: 76.5500 },
      { name: 'Athani',                 order: 5, expectedTime: 28, latitude: 10.2130, longitude: 76.5300 },
      { name: 'SSET College',           order: 6, expectedTime: 35, latitude: 10.2167, longitude: 76.5167 },
    ],
  },
  {
    routeId: 'ROUTE_2',
    ...
    stops: [
      ...
      { name: 'Koratty',                order: 3, expectedTime: 20, latitude: 10.2667, longitude: 76.3833 },
      { name: 'Muringoor',              order: 4, expectedTime: 35, latitude: 10.2450, longitude: 76.4500 },
      { name: 'Karukutty',              order: 5, expectedTime: 47, latitude: 10.2200, longitude: 76.5000 },
      { name: 'SSET College',           order: 6, expectedTime: 55, latitude: 10.2167, longitude: 76.5167 },
    ],
  },
  {
    routeId: 'ROUTE_3',
