...
const ROUTES = [
  {
    ...
    startTime: '07:45', eveningStartTime: '16:00', duration: '50 mins', totalDuration: 50, price: 25, active: true,
    stops: [
      { name: 'North Paravur',                             order: 1,  expectedTime: 0,  latitude: 10.1524, longitude: 76.2149 },
      { name: 'Vedimara',                                  order: 2,  expectedTime: 5,  latitude: 10.1623, longitude: 76.2354 },
      { name: 'Mannam',                                    order: 3,  expectedTime: 10, latitude: 10.1712, longitude: 76.2601 },
      { name: 'Manakapady',                                order: 4,  expectedTime: 15, latitude: 10.1834, longitude: 76.2912 },
      { name: 'Thatampady',                                order: 5,  expectedTime: 20, latitude: 10.1923, longitude: 76.3178 },
      { name: 'Karumaloor',                                order: 6,  expectedTime: 25, latitude: 10.2012, longitude: 76.3456 },
      { name: 'Kottapuram',                                order: 7,  expectedTime: 30, latitude: 10.2089, longitude: 76.3712 },
      { name: 'Malikampeedika',                            order: 8,  expectedTime: 35, latitude: 10.2134, longitude: 76.3978 },
      { name: 'UC College',                                order: 9,  expectedTime: 40, latitude: 10.2156, longitude: 76.4234 },
      { name: 'Paravur Kavala',                            order: 10, expectedTime: 45, latitude: 10.2167, longitude: 76.4712 },
  ...
  },
  {
    ...
    stops: [
      ...
      { name: 'Palarivattom',                             order: 2, expectedTime: 10, latitude: 10.0024, longitude: 76.3119 },
