...
const ROUTES = [
  {
    ...
    stops: [
      { name: 'North Paravur',                             order: 1, expectedTime: 0,  latitude: 10.1504, longitude: 76.2154 },
      { name: 'Manjaly',                                   order: 2, expectedTime: 10, latitude: 10.1583, longitude: 76.2541 },
      { name: 'Kunnukara',                                 order: 3, expectedTime: 22, latitude: 10.1747, longitude: 76.3012 },
      { name: 'Chengamanad',                               order: 4, expectedTime: 35, latitude: 10.1862, longitude: 76.3524 },
      { name: 'Athani',                                    order: 5, expectedTime: 46, latitude: 10.1985, longitude: 76.4073 },
      { name: 'Angamaly',                                  order: 6, expectedTime: 55, latitude: 10.1960, longitude: 76.3800 },
      { name: 'Karukutty',                                 order: 7, expectedTime: 65, latitude: 10.2133, longitude: 76.5047 },
      { name: 'SCMS School of Engineering and Technology', order: 8, expectedTime: 73, latitude: 10.2268, longitude: 76.5419 },
    ],
  },
  {
    routeId: 'ROUTE_2',
