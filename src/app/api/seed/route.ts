...
const ROUTES = [
  {
    ...
    stops: [
      ...
      { name: 'Vedimara',                                  order: 2,  expectedTime: 5,  latitude: 10.1467, longitude: 76.2580 },
      { name: 'Mannam',                                    order: 3,  expectedTime: 10, latitude: 10.1530, longitude: 76.2870 },
      { name: 'Manakapady',                                order: 4,  expectedTime: 15, latitude: 10.1600, longitude: 76.3150 },
      { name: 'Thatampady',                                order: 5,  expectedTime: 20, latitude: 10.1670, longitude: 76.3430 },
      { name: 'Karumaloor',                                order: 6,  expectedTime: 25, latitude: 10.1740, longitude: 76.3720 },
      { name: 'Kottapuram',                                order: 7,  expectedTime: 30, latitude: 10.1810, longitude: 76.4010 },
      { name: 'Malikampeedika',                            order: 8,  expectedTime: 35, latitude: 10.1880, longitude: 76.4300 },
      { name: 'UC College',                                order: 9,  expectedTime: 40, latitude: 10.1950, longitude: 76.4590 },
      { name: 'Paravur Kavala',                            order: 10, expectedTime: 45, latitude: 10.2020, longitude: 76.4880 },
      { name: 'SCMS School of Engineering and Technology', order: 11, expectedTime: 50, latitude: 10.2100, longitude: 76.5150 },
    ],
  },
  {
    routeId: 'ROUTE_2',
