...
const ROUTES = [
  {
    ...
    stops: [
      ...
      { name: 'Manjaly',                                   order: 2, expectedTime: 10, latitude: 10.1490, longitude: 76.2680 },
      { name: 'Kunnukara',                                 order: 3, expectedTime: 22, latitude: 10.1620, longitude: 76.3050 },
      { name: 'Chengamanad',                               order: 4, expectedTime: 32, latitude: 10.1720, longitude: 76.3420 },
      { name: 'Angamaly',                                  order: 5, expectedTime: 42, latitude: 10.1960, longitude: 76.3860 },
      { name: 'Athani',                                    order: 6, expectedTime: 52, latitude: 10.2080, longitude: 76.4380 },
